...
router.put('/editar-maquina-mantenimiento/:id', async (req, res) => {
    ...
    try {
        ...
        let {
            ...
            cedula, nombrecorresponsal, codigoseta, estado, fecha, conteoenvio, ubicacion, historialmantenimiento
        } = req.body;
        ...
        let query = `UPDATE maquinasmantenimiento SET ${setQuery} WHERE id = $${valores.length + 1} RETURNING *;`;
        valores.push(id);
