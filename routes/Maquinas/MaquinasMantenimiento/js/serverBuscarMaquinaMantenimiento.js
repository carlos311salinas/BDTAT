...
// Ruta para buscar maquinas en la base de datos
router.get('/buscar-maquina-mantenimiento', async (req, res) => {
    try {
        const filtros = req.query; // Recibir filtros de la URL
        let query = 'SELECT * FROM maquinasmantenimiento WHERE 1=1';
        let params = [];
        ...
        console.error('Error en la búsqueda de maquinas:', error);
