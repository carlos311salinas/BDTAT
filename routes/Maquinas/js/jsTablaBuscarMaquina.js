...
document.getElementById("btnLimpiar").addEventListener("click", () => {
    setTimeout(() => {
        const tableMotivoEnvio = document.getElementById("tablahistorial");
        const tableMaquinas = document.getElementById("tablamaquinas");

        // LIMPIAR TABLA 'tablahistorial'
        if (tableMotivoEnvio) {
            ...
            console.log("✅ Tabla 'tablahistorial' limpiada.");
        } else {
            console.warn("⚠️ No se encontró la tabla 'tablahistorial'.");
        }
